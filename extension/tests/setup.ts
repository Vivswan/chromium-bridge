...
// the storage write locks require one. Minimal exclusive-only stub with FIFO
// ordering per lock name. defineProperty is required: plain assignment would
// hit happy-dom's getter-only property.
if (!navigator.locks) {
