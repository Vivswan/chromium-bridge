 ...
 *      asserted by extension/tests/entrypoints/background.test.ts, and the
 ...
 *
 * Run:  CHROME_BIN=/path/to/chrome-for-testing bun tests/security_browser_test.ts
...
// isolated Chrome for Testing (see tests/browser-safety.ts).
...
async function main(): Promise<void> {
  ...
  try {
    ...
    // test: extension/tests/entrypoints/background.test.ts. The function's
