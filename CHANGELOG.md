...
* **ci:** add SSoT parity gates for docs, adversarial tests, fuzz seeds, and the browser job ([#28](https://github.com/Vivswan/chromium-bridge/issues/28)) ([ff0c96f](https://github.com/Vivswan/chromium-bridge/commit/ff0c96fd679f42811606c81aa1f0a05ab72f580d))
* **ci:** persist and minimize the fuzz corpus nightly ([211b6a9](https://github.com/Vivswan/chromium-bridge/commit/211b6a96e93428df3f8bf80f4a0128509bcfae1d))
...
* **contract:** emit audit forwarding, writer frame types, and the MCP version from the core ([#29](https://github.com/Vivswan/chromium-bridge/issues/29)) ([ad02bd9](https://github.com/Vivswan/chromium-bridge/commit/ad02bd9e7fed56dc33fdac8374e5acd2ee3078b5))
...
* **core:** emit the enclave contract and golden vectors to the shared TS package ([#30](https://github.com/Vivswan/chromium-bridge/issues/30)) ([18680f8](https://github.com/Vivswan/chromium-bridge/commit/18680f851687e5e0b95511af4fd02c61fced18f8))
...
* file nightly fuzz crashes as tracking issues with seeded replay ([ff1be43](https://github.com/Vivswan/chromium-bridge/commit/ff1be43673f9dca7b051a7b6b316d1a961b5bd5d))
* **fuzz:** add classify_frame, enclave, and manifest targets ([f8940d3](https://github.com/Vivswan/chromium-bridge/commit/f8940d3316def45c36b310593dbd66d09ffeee8d))
* **fuzz:** add fuzzing feature and handshake_verify target ([42a9198](https://github.com/Vivswan/chromium-bridge/commit/42a91982f61b2e57e2c881eb0b6ee782fbbd248c))
* **fuzz:** seed corpora and dictionaries ([2caca11](https://github.com/Vivswan/chromium-bridge/commit/2caca114b72bfbead9e762cd04934d02068d5487))
...
* migrate .repo-platform.yml to the modules schema ([#12](https://github.com/Vivswan/chromium-bridge/issues/12)) ([8430910](https://github.com/Vivswan/chromium-bridge/commit/843091081b3f9c8cdea4aa08154725b5f1eac184))
...
* **ci:** scope fuzz deny relaxations to a fuzz-only config ([85f531c](https://github.com/Vivswan/chromium-bridge/commit/85f531cfbccfd47b87822cf4785ed97a9835a50d))
* **ci:** unbreak the first nightly run (fuzz musl target, mutants exit 3) ([c82a5de](https://github.com/Vivswan/chromium-bridge/commit/c82a5de024d185a836a977a66042cf61980753db))
...
* **core:** enforce trust-store preconditions and anchor validity in types ([#24](https://github.com/Vivswan/chromium-bridge/issues/24)) ([dbd3cc2](https://github.com/Vivswan/chromium-bridge/commit/dbd3cc24582c8102367aa97cffd35c22c3219448))
...
* cover desktop ui package.json in release-please and guard version sync ([#23](https://github.com/Vivswan/chromium-bridge/issues/23)) ([f911eff](https://github.com/Vivswan/chromium-bridge/commit/f911eff234282ddec76361bfab9c5d9414b920e3))
...
* **extension:** bind confirmed ops to their origin and parse reply envelopes fail-closed ([#25](https://github.com/Vivswan/chromium-bridge/issues/25)) ([67c6e49](https://github.com/Vivswan/chromium-bridge/commit/67c6e498576ed90d96890061619d641cb9406464))
